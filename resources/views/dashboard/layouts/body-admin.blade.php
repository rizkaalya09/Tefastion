            ...
            <div class="col-md-4">
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-text">Total number of products: {{$products->count()}}</p>
                </div>
              </div>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-text">Total sales: {{ $sales->count() }}</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  @foreach ($topSellers as $seller)
                      <li class="list-group item">{{$seller->user->name}} - {{$seller->sales_count}} sold</li>
                  @endforeach
                  </ul>
                </div>
              </div>
